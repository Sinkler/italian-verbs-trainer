...
var ASCIIFolder = function () {
    function ASCIIFolder() {
        _classCallCheck(this, ASCIIFolder);
    }

    _createClass(ASCIIFolder, null, [{
        key: 'fold',
        ...
        key: 'replaceChar',
        value: function replaceChar(char, replacement) {
            var ascii = ASCIIFolder.mapping.get(char.charCodeAt(0));
